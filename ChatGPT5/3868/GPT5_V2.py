...
def minCost(self, nums1, nums2):  # pylint: disable=invalid-name
    ...
    # Every value must occur an even number of times overall, because
    # both final arrays must contain exactly the same multiset of values.
    ...
    # Count how many elements must effectively move from nums1 to nums2.
    required_swaps = sum(
        count // 2
    ...
    # A paid swap can only help at an index where the two arrays currently
