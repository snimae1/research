...
class Solution(object):
    ...
    def _can_fix_imbalance(self, left, right, balance, first_zero,
        ...
        """Check whether one swap can fix the imbalance."""

        if balance == 2:
            # A zero outside the substring is needed.
            return first_zero < left or last_zero >= right

        if balance == -2:
            # A one outside the substring is needed.
    ...
    def longestBalanced(self, s):
        ...
        for right, char in enumerate(s, 1):
            ...
            # Equal prefix balances mean the substring is balanced.
            ...
            # A balance of +2 or -2 can be fixed with one swap.
