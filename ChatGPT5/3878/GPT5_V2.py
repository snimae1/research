...
def countGoodSubarrays(self, nums):  # pylint: disable=invalid-name
    ...
    for end, value in enumerate(nums):
        ...
        # The subarray containing only nums[end].
        ...
        # For each OR value, all starts in [left, right]
        # produce this same OR. The subarray is good if
        # that OR value occurs somewhere inside the subarray.
